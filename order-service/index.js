...
// Return the user object if found, null if service down, and empty string if object not found.
...
// Return the product object if found, null if service down, and empty string if object not found
